...
def test_volumes_data_integrity(num_vols):
    ...
    try:
        ...
        for index, array_name in enumerate(pos.cli.array_dict.keys()):
            ...
            assert pos.target_utils.create_volume_multiple(array_name, num_vols[index], size=vol_size) == True
            ...
            assert pos.client.nvme_connect(nqn, pos.target_utils.helper.ip_addr[0], "1158") == True
...
def test_max_size_volume_data_integrity():
    ...
    logger.info("================ Test: test_max_size_volume_data_integrity ================")
    try:
        assert pos.cli.list_array()[0] == True
        for index,array_name in enumerate(pos.cli.array_dict.keys()):
            assert pos.cli.info_array(array_name=array_name)[0] == True
