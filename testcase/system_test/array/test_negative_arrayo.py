...
@pytest.mark.regression
def test_remove_spare_without_array_mount(raid_type="RAID5", nr_data_drives=3):
    logger.info(" ==================== Test : test_add_spare_without_mount ================== ")
    try:
        assert negative_test_setup_function(nr_data_drives) == True
        spare_disk_list = [system_disks.pop()]
...
@pytest.mark.regression
def test_uram_creation_after_scan(nr_data_drives=3):
...
@pytest.mark.regression
def test_delete_create_array(raid_type="RAID5", nr_data_drives=3):
    logger.info(" ==================== Test : test_add_spare_without_mount ================== ")
    try:
        assert negative_test_setup_function(nr_data_drives) == True
        spare_disk_list = [system_disks.pop()]
...
@pytest.mark.regression
def test_logger_info(raid_type="RAID5", nr_data_drives=3):
    logger.info(" ==================== Test : test_add_spare_without_mount ================== ")
    try:
        assert negative_test_setup_function(nr_data_drives) == True
        spare_disk_list = [system_disks.pop()]
