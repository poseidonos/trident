    ...
    try:
        ...
        for array_name in pos.cli.array_dict.keys():
            ...
            for vol_name in pos.cli.vols:
                assert (
                    pos.cli.unmount_volume(array_name=array_name, volumename=vol_name)[
                        0
                    ]
                    == True
                )
                assert (
                    pos.cli.delete_volume(array_name=array_name, volumename=vol_name)[0]
                    == True
                )
