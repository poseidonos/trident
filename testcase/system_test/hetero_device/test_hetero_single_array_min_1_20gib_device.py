...
def test_hetero_array_all_raid(hetero_setup, raid_type, num_disk):
    ...
    try:
        ...
        assert create_hetero_array(pos, raid_type, data_device_conf) == True
...
def test_hetero_array_all_dev_fio(hetero_setup, raid_type, mount_type):
    ...
    try:
        ...
        assert create_hetero_array(pos, raid_type, data_device_conf,
                                   array_mount=write_back, array_info=True) == True
