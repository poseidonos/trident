import logging, sys, os, datetime, platform
from logging.handlers import TimedRotatingFileHandler

path = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + "/logs/POS_" + datetime.datetime.now().strftime('%Y-%m-%d_%H_%M')
